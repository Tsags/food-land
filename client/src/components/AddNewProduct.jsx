...
const AddNewProduct = () => {
  ...
  const createNewProduct = () => {
    dispatch(uploadProduct({ name, category, stock, price, image, productIsNew, description }));
  };
  ...
  return (
    <Tr>
      <Td>
        ...
        <Tooltip label="Set the name of your image e.g., burger.jpg" fontSize="sm">
          <Input size="sm" value={image} onChange={(e) => setImage(e.target.value)} placeholder="e.g., burger.jpg" />
        </Tooltip>
      </Td>
      <Td>
